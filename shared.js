...
function updateAuthUI() {
  ...
  if (!area) return;
  const cartSvg = `<svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>`;
  if (currentUser) {
    ...
    area.innerHTML = `
      ...
      <button class="cart-btn" onclick="toggleCart()">
        ${cartSvg}&nbsp;Cart <span class="cart-count" id="cart-count">${cart.length}</span>
      </button>`;
  } else {
    area.innerHTML = `
...
function submitPW() {
  ...
  setTimeout(()=>{
    ...
    err.textContent='API endpoint not connected. Integrate UZMA API to verify.';
  }, 1600);
}
  ...
  footer.innerHTML = `
    <div class="site-footer-inner">
      <div class="site-footer-brand">
        <img src="LogoUzma.png" alt="UZMA">
        <span class="site-footer-name">UZMA</span>
      </div>
      <div class="site-footer-links">
        <a class="site-footer-link" href="marketplace.html">Marketplace</a>
        <a class="site-footer-link" href="products.html">Products</a>
        <a class="site-footer-link" href="coverage.html">Coverage</a>
        <a class="site-footer-link" href="api-docs.html">API Docs</a>
      </div>
      <div class="site-footer-copy">
        © ${new Date().getFullYear()} UZMA Geospatial AI Platform · Malaysia · All rights reserved
      </div>
    </div>`;
